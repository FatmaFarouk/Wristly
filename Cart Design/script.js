...
export const database = {
    ...
    currentUser: {
        id: 1, name: "John Doess", email: "johndoe@example.com", password: "securepassword123", 
        cart: [{ id: 1, quantity: 5 },], accountType: "Customer", products: [], orderIds: [101, 102, 103],
        address: {
            street: "567 Oak St",
               city: "Esna",
                governorate: "luxor"
        },
        mobileNumber: "01245678901"
    },


    users: [
        {
            id: 1, name: "John Doe", email: "johndoe@example.com", password: "securepassword123", cart: [], accountType: "Customer", products: [], orderIds: [101, 102, 103], address: {
                street: "567 Oak St",
                city: "Esna",
                governorate: "luxor"
            },
        ...
        {
            id: 2, name: "Jane Smith", email: "janesmith@example.com", password: "anothersecurepassword456", cart: [], accountType: "Seller", products: [1, 2, 10, 11, 12, 13, 14, 15], orderIds: [104, 105], address: {
                street: "567 ahmed oraby St",
                city: "Dokki",
                governorate: "Giza"
            },
            mobileNumber: "01012589647"
        },
        {
            id: 3, name: "Alice Johnson", email: "alicejohnson@example.com", password: "yetanothersecurepassword789", cart: [], accountType: "Admin", products: [], orderIds: [], address: {
                street: "567 apple St",
                city: "Edfu",
                governorate: "Aswan"
            },
        ...
        {
            id: 4, name: "Robert Brown", email: "robertb@example.com", password: "password12345", cart: [], accountType: "Customer", products: [], orderIds: [106, 107], address: {
                street: "54 ali St",
                city: "Al-Montazah",
                governorate: "alex"
            },
        ...
        {
            id: 5, name: "Emma Davis", email: "emmad@example.com", password: "password67890", cart: [], accountType: "Customer", products: [], orderIds: [108, 109], address: {
                street: "Suez Canal St",
                city: "El Mostaqbal",
                governorate: "Ismailia"
            },
            mobileNumber: "01245644901"
        },
        {
            id: 6, name: "Liam Wilson", email: "liamwilson@example.com", password: "liampassword987", cart: [], accountType: "Seller", products: [3, 4], orderIds: [110, 111], address: {
                street: "890 Birch St",
                city: "El Dawahi",
                governorate: "Port Said"
            },
            mobileNumber: "01265498732"
        },
        {
            id: 7, name: "Sophia Martinez", email: "sophiam@example.com", password: "sophiapassword321", cart: [], accountType: "Seller", products: [5, 6], orderIds: [112, 113], address: {
                street: "101 Poplar St",
                city: "Hurghada",
                governorate: "Red Sea"
            },
            mobileNumber: "01176543219"
        },
        {
            id: 8, name: "Ethan Lee", email: "ethanlee@example.com", password: "ethanpassword654", cart: [], accountType: "Customer", products: [], orderIds: [114, 115], address: {
                street: "202 Palm St",
        ...
        {
            id: 9, name: "Mia Gonzalez", email: "miagonzalez@example.com", password: "miapassword789", cart: [], accountType: "Seller", products: [7, 8], orderIds: [116, 117], address: {
                street: "456 Elm St",
                city: "Zamalek",
                governorate: "Cairo"
            },
        ...
        {
            id: 10, name: "William Taylor", email: "williamtaylor@example.com", password: "williamsecurepassword123", cart: [], accountType: "Customer", products: [], orderIds: [118, 119], address: {
                street: "567 Oak St",
                city: "Esna",
                governorate: "Luxor"
            },
    ...
    products: [
        {
            ...
            brandId: 1,
            date: "2023-10-01",
            images: ["https://m.media-amazon.com/images/I/71VjM5LOeYL._AC_SL1500_.jpg", "classic2.jpg", "classic3.jpg"],
            gender: "Men"
        },
        {
            id: 2,
            ...
            brandId: 2,
            date: "2023-11-15",
            images: ["https://m.media-amazon.com/images/I/71VjM5LOeYL._AC_SL1500_.jpg", "sport2.jpg"],
            gender: "Unisex"
        },
        {
            id: 3,
...
console.log(GetProductRelatedToSeller(2));
loadDatabaseFromLocalStorage();